...
def fetch_openrouter_models(
    ...
    for preferred_id, _ in fallback:
        ...
        # tool-capable model, so its own catalog entry lists no tools but it is still usable.
        if live_item is None or (preferred_id != "openrouter/pareto-code" and not _openrouter_model_supports_tools(live_item)):
            continue
