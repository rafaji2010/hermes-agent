...
def data_training_warning(
    ...
    *,
    ...
    """Warning payload when *model_name* selects a data-training tier, else ``None`` (also ``None`` once
    the user has acknowledged the tier). Call after model resolution; surface ``.message`` as a confirm prompt."""
