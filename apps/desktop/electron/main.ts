  ...
  const child = spawn(
    ...
    hiddenWindowsChildOptions({
      ...
      env: {
        ...
        ...parentIdentityEnv,
        // Fork divergence (webdist merge-drop regression): force the backend
        // to serve its own hermes_cli/web_dist build. esbuild minifies this
        // to `void 0`, so the key is dropped from the child env entirely.
