...
class AIAgent:
    ...
    def _is_opencode_ai_host(base_url: str) -> bool:
        ...
        from agent.process_bootstrap import _is_opencode_ai_host as _impl
    ...
    def _rewrite_opencode_model_first(request: Any) -> Any:
        ...
        Delegates to :func:`agent.process_bootstrap._rewrite_opencode_model_first`
        so the transport seam fix lives in the extracted builder (see
        :mod:`agent.process_bootstrap`) while ``AIAgent`` keeps a stable shim
        for :mod:`tests.run_agent.test_opencode_model_first_transport` and
        any external callers.
        """
        from agent.process_bootstrap import _rewrite_opencode_model_first as _impl
    ...
    def _build_opencode_model_first_transport(*args: Any, **kwargs: Any) -> Any:
        ...
        from agent.process_bootstrap import _build_opencode_model_first_transport as _impl
