...
class AIAgent(
    ...
    # opencode.ai model-first shims (policy owner: ``agent.process_bootstrap``) — kept on the facade for
    # tests/run_agent/test_opencode_model_first_transport.py and external callers.
    _is_opencode_ai_host = _forward_static("agent.process_bootstrap", "_is_opencode_ai_host")
    _rewrite_opencode_model_first = _forward_static("agent.process_bootstrap", "_rewrite_opencode_model_first")
    _build_opencode_model_first_transport = _forward_static(
        "agent.process_bootstrap", "_build_opencode_model_first_transport")
